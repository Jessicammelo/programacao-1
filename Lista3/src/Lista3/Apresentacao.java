...
public class Apresentacao extends javax.swing.JFrame {
	...
	public Vereador ver = new Vereador();
	...
	private void initComponents() {
		...
		jButton3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String str;
				if (v == null) {
					str = "N�o h� vereadores cadastrados";
				} else {
		...
		btnProjetosDeLei = new JButton("Projetos de Lei");
		btnProjetosDeLei.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ProjetoDeLei projeto = new ProjetoDeLei();
				projeto.setTitulo(JOptionPane.showInputDialog("Qual o nome do projeto?"));
				String data = JOptionPane.showInputDialog("Qual a data de apresentação?");
				SimpleDateFormat format = new SimpleDateFormat("dd/MM/yyyy");
				Date data1 = null;
				try {
					data1 = format.parse(data);
				} catch (ParseException e1) {
					System.out.println("Dataa inválida");
				}
				projeto.setDataApresentacao(data1);
				String data2 = JOptionPane.showInputDialog("Qual a data da aprovação?");
				Date data3 = null;
				try {
					data1 = format.parse(data2);
				} catch (ParseException e1) {
					System.out.println("Dataa inválida");
				}
				projeto.setDataAprovacao(data3);
				String numero = JOptionPane.showInputDialog("Digite o número do projeto");
				projeto.setNumeroProjeto(Integer.parseInt(numero));
				ver.getProjetosDeLei().add(projeto);

			}
		});

		btnProjetosDeLei_1 = new JButton("Projetos de Lei Complementar");
		btnProjetosDeLei_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ProjetoDeLeiComplementar projeto = new ProjetoDeLeiComplementar();
				projeto.setTitulo(JOptionPane.showInputDialog("Qual o nome do projeto?"));
				String data = JOptionPane.showInputDialog("Qual a data de apresentação?");
				SimpleDateFormat format = new SimpleDateFormat("dd/MM/yyyy");
				Date data1 = null;
				...
				String numero = JOptionPane.showInputDialog("Digite o número do projeto");
				projeto.setNumeroProjeto(Integer.parseInt(numero));
				String artigo = JOptionPane.showInputDialog("Tem o artigo de Lei Orgânica?");
				projeto.setArtigoLO(artigo);
				String votos = JOptionPane.showInputDialog("Quantidades de votos favoráveis");
				projeto.setQuantVotosFavoraveis(Integer.parseInt(votos));
				ver.getProjetosDeLei().add(projeto);
								...
								.addGroup(jPanel2Layout.createParallelGroup(Alignment.LEADING, false)
										...
										.addGroup(jPanel2Layout.createSequentialGroup()
												.addGroup(jPanel2Layout.createParallelGroup(Alignment.TRAILING)
														...
														.addGroup(jPanel2Layout.createSequentialGroup()
																.addComponent(jLabel6).addGap(26)))
												.addPreferredGap(ComponentPlacement.RELATED)
												.addGroup(jPanel2Layout.createParallelGroup(Alignment.LEADING, false)
														.addComponent(jTextField5, GroupLayout.DEFAULT_SIZE, 40,
																Short.MAX_VALUE)
														.addComponent(jTextField6).addComponent(btnProjetosDeLei_1)))))
						.addGroup(jPanel2Layout.createSequentialGroup().addGap(148).addComponent(jButton2))
						.addGroup(jPanel2Layout.createSequentialGroup().addGap(68).addComponent(btnProjetosDeLei)))
		...
		jPanel2Layout.setVerticalGroup(jPanel2Layout.createParallelGroup(Alignment.LEADING).addGroup(jPanel2Layout
				...
				.addGroup(jPanel2Layout.createParallelGroup(Alignment.BASELINE).addComponent(jLabel5).addComponent(
						jTextField5, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
				.addPreferredGap(ComponentPlacement.UNRELATED)
				.addGroup(jPanel2Layout.createParallelGroup(Alignment.BASELINE).addComponent(jLabel6).addComponent(
				...
				.addGap(18).addGroup(jPanel2Layout.createParallelGroup(Alignment.BASELINE)
						.addComponent(btnProjetosDeLei).addComponent(btnProjetosDeLei_1))
				.addGap(45).addComponent(jButton2).addContainerGap()));
		...
		jLabel9.setText("N�mero do partido:");

		jButton5.setText("Estat�sticas do partido");

		jButton6.setText("Total de projetos da C�mara");
		...
		jButton7.setText("Vereadores acima da m�dia");
		...
		btnMostrarProjetosDe = new JButton("Mostrar projetos de Lei");
		btnMostrarProjetosDe.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				camara.getProjetoDeLei();
			}
		});
			...
			jPanel3Layout.createParallelGroup(Alignment.LEADING)
				.addGroup(jPanel3Layout.createSequentialGroup()
					.addGroup(jPanel3Layout.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(btnMostrarProjetosDe))
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
		...
		try {
			if (camara.getPartido(Integer.parseInt(jTextField1.getText())) == null) {
				...
				str = "J� h� partido com este n�mero. Escolha outro n�mero";
			}
	...
	private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if (p == null) {
			jLabel8.setText("N�mero do partido n�o localizado");
	...
	private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {
		...
		String str = "Vereadores acima da m�dia (" + camara.getMediaDesempenho() + ")\n";
	...
	private JButton btnProjetosDeLei;
	private JButton btnProjetosDeLei_1;
	private JButton btnMostrarProjetosDe;
}